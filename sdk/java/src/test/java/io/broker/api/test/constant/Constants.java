...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: coinlead.cc
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.coinlead.cc
    ...
    // for example: wss://wsapi.coinlead.cc/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.coinlead.cc/openapi/ws
